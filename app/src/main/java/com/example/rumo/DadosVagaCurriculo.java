                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    if (response.isSuccessful()) {
                        try {
                            ...
                            // Exibe o resultado provisório em uma caixa de diálogo na tela
                            runOnUiThread(() -> exibirResultadoFinal(curriculoGerado));

                        } catch (Exception e) {
                            Log.e("IA_ERROR", "Erro ao processar resposta", e);
                        }
                    } else {
                        runOnUiThread(() -> Toast.makeText(DadosVagaCurriculo.this, "Erro na API da IA", Toast.LENGTH_SHORT).show());
                    }
                }
            });
